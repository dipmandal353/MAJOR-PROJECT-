...
import behaveData from "./BehavioralData"
import { Scroll } from "lucide-react"

function BehaveInterview() {
  ...
  return (
    <div className="study-tracker__wrapper">
      ...
      <div className="study-tracker">
        <DSATracker
          customData={behaveData}
          storageKey="behavioralInterviewTrackerData"
          hideTitle={true}
          hideHeader={true}
          columnConfig={{
            practice: {
...
export default BehaveInterview
